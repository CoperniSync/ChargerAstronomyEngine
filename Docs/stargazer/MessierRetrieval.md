# <a id="MessierRetrieval"></a> Class MessierRetrieval
...
[MessierRetrieval](MessierRetrieval.md)
...
### <a id="MessierRetrieval_GetMessier_ChargerAstronomyShared_Contracts_Repositories_IEngineService_ChargerAstronomyShared_Contracts_Models_IHorizontal__System_String_"></a> GetMessier\(IEngineService<IHorizontal\>, string\)
