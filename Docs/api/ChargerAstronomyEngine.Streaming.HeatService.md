# <a id="ChargerAstronomyEngine_Streaming_HeatService"></a> Class HeatService
...
### <a id="ChargerAstronomyEngine_Streaming_HeatService__ctor_ChargerAstronomyShared_Domain_Heat_HeatMap_ChargerAstronomyShared_Domain_Index_ITileIndex_ChargerAstronomyEngine_CosineKittyAstronomy_Astronomy_"></a> HeatService\(HeatMap, ITileIndex, Astronomy\)
...
### <a id="ChargerAstronomyEngine_Streaming_HeatService_heatMap"></a> heatMap
...
### <a id="ChargerAstronomyEngine_Streaming_HeatService_index"></a> index
...
### <a id="ChargerAstronomyEngine_Streaming_HeatService_GetActiveTiles"></a> GetActiveTiles\(\)
...
### <a id="ChargerAstronomyEngine_Streaming_HeatService_GetHeatMap"></a> GetHeatMap\(\)
...
### <a id="ChargerAstronomyEngine_Streaming_HeatService_GetInactiveTiles"></a> GetInactiveTiles\(\)
...
### <a id="ChargerAstronomyEngine_Streaming_HeatService_GetTileIndex"></a> GetTileIndex\(\)
...
### <a id="ChargerAstronomyEngine_Streaming_HeatService_Step_System_Single_System_Numerics_Vector3_System_Single_"></a> Step\(float, Vector3, float\)
...
### <a id="ChargerAstronomyEngine_Streaming_HeatService_UpdateTimeAndLocation_ChargerAstronomyEngine_CosineKittyAstronomy_AstroTime_ChargerAstronomyShared_Domain_Observer_"></a> UpdateTimeAndLocation\(AstroTime, Observer\)
