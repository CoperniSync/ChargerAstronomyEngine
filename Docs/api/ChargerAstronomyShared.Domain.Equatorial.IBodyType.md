# <a id="ChargerAstronomyShared_Domain_Equatorial_IBodyType"></a> Interface IBodyType
...
### <a id="ChargerAstronomyShared_Domain_Equatorial_IBodyType_BodyType"></a> BodyType
