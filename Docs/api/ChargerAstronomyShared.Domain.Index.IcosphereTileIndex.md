# <a id="ChargerAstronomyShared_Domain_Index_IcosphereTileIndex"></a> Class IcosphereTileIndex
...
### <a id="ChargerAstronomyShared_Domain_Index_IcosphereTileIndex__ctor_System_Int32_"></a> IcosphereTileIndex\(int\)

Initializes a new instance of the <xref href="ChargerAstronomyShared.Domain.Index.IcosphereTileIndex" data-throw-if-not-resolved="false"></xref> class with a specified number of
subdivisions.
...
`subdivisions` [int](https://learn.microsoft.com/dotnet/api/system.int32)

The number of times the base icosahedron is subdivided to create the icosphere.  Must be between 0 and 5,
    inclusive. Higher values result in a finer-grained icosphere.

#### Remarks

This constructor generates an icosphere by subdividing a base icosahedron the
    ...
    associated with a unique tile identifier and its corresponding geometry.

#### Exceptions

 [ArgumentOutOfRangeException](https://learn.microsoft.com/dotnet/api/system.argumentoutofrangeexception)

Thrown if <code class="paramref">subdivisions</code> is less than 0 or greater than 5.

## Properties

### <a id="ChargerAstronomyShared_Domain_Index_IcosphereTileIndex_TileCount"></a> TileCount
...
### <a id="ChargerAstronomyShared_Domain_Index_IcosphereTileIndex_Tiles"></a> Tiles
...
### <a id="ChargerAstronomyShared_Domain_Index_IcosphereTileIndex_DirectionToTileId_System_Numerics_Vector3_"></a> DirectionToTileId\(Vector3\)
...
### <a id="ChargerAstronomyShared_Domain_Index_IcosphereTileIndex_Enumerate"></a> Enumerate\(\)
...
### <a id="ChargerAstronomyShared_Domain_Index_IcosphereTileIndex_EnumerateGeometry"></a> EnumerateGeometry\(\)
...
### <a id="ChargerAstronomyShared_Domain_Index_IcosphereTileIndex_GetGeometry_ChargerAstronomyShared_Contracts_Models_TileId_"></a> GetGeometry\(TileId\)
...
### <a id="ChargerAstronomyShared_Domain_Index_IcosphereTileIndex_GetTileAlpha_ChargerAstronomyShared_Contracts_Models_TileId_"></a> GetTileAlpha\(TileId\)
...
### <a id="ChargerAstronomyShared_Domain_Index_IcosphereTileIndex_GetTileCenter_ChargerAstronomyShared_Contracts_Models_TileId_"></a> GetTileCenter\(TileId\)
...
### <a id="ChargerAstronomyShared_Domain_Index_IcosphereTileIndex_Neigbors_ChargerAstronomyShared_Contracts_Models_TileId_"></a> Neigbors\(TileId\)
